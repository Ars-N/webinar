  ...
  return (
    ...
    >
      <Controller
        ...
        defaultValue=""
        rules={{ required: true }}
        render={({ field }) => <TextField {...field} label="TODO" fullWidth className={classes.root} />}
      />
      <Controller
        name="details"
        control={control}
        defaultValue=""
        render={({ field }) => <TextField {...field} label="Details" fullWidth multiline className={classes.root} />}
      />
